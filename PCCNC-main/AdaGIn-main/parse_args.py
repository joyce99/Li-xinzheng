...
def parse_args():
    ...
    parser.add_argument('--output_dims', type=str, default='512,256,64')
    parser.add_argument('--arch_cly', type=str, default="", help='node classifier architecture')
    parser.add_argument('--arch_disc', type=str, default="256-32-16", help='domain discriminator architecture')
